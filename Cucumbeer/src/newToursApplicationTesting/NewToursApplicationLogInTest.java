...
public class NewToursApplicationLogInTest 
{
	...
	@Then("^User should be able to successfuly LogIN to the Application$")
	public void User_should_be_able_to_successfuly_LogIN_to_the_Application() throws Throwable
	{
	...
	@Then("^Userse should SignOff and Close the Application$")
	public void Userse_should_SignOff_and_Close_the_Application() throws Throwable 
	{
